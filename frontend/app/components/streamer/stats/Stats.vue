<template>
  <div class="grid grid-cols-4 gap-4 h-full">
    <StatsItem title="Фолловеры" icon="mdi:account-supervisor-outline" :data="props.stats?.followers" />
    <StatsItem title="Среднее кол-во зрителей" icon="mdi:eye-outline" :data="props.stats?.avgViewers" />
